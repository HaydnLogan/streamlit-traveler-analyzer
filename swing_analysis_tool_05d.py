"""
Swing Analysis Tool 05d - Integrated Version
=============================================
Features:
...
st.set_page_config(
    page_title="Swing Analysis Tool 05d",
    page_icon="📊",
    layout="wide"
)
...
def main():
    st.title("📊 Market Swing Analysis Tool 05d")
            ...
            with st.spinner("Analyzing daily swings..."):
                ...
                if daily_stats:
                    ...
                    st.download_button(
                        ...
                        file_name=f"swing_analysis_05d_{datetime.now().strftime('%Y%m%d_%H%M')}.xlsx",
