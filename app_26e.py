# v26c - Cleaned up version with proper imports and measurement tab selection
...
st.header("🧬 Data Feed Processor + Model A/B/C Detector. v26e")
...
# Main processing section (feeds upload)
    ...
    if True:  # Always process when files are uploaded
        ...
        if 'Output' in final_df.columns:
            ...
            if st.button("📊 Generate Traveler Report", key="generate_report_btn"):
