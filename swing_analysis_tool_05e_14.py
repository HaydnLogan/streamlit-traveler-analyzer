...
from custom_range_calculator_1125_14 import (
...
st.set_page_config(
    page_title="Swing Analysis Tool 05e_14",
    page_icon="",
    layout="wide"
)
...
def main():
    st.title(" Market Swing Analysis Tool 05e_14 Two Pass")
        ...
        if not min_files_met:
            ...
            **Minimum Requirements:**
            ...
            try:
                ...
                st.markdown("**Feed Selection & Matching:**")
                col_feed1, col_feed2 = st.columns(2)
                
                with col_feed1:
                    st.markdown("*Which feed(s) to process:*")
                ...
                if feed_selection == "Both feeds":
                    if match_type_selection == "Same feed only":
                        st.caption("✓ Processing both feeds, matching within each feed separately")
                    else:
                        st.caption("✓ Processing both feeds, allowing matches across feeds")
                elif feed_selection == "Small feed only":
                    st.caption("✓ Processing Small feed only, matching within Small feed")
                elif feed_selection == "Big feed only":
                    st.caption("✓ Processing Big feed only, matching within Big feed")
