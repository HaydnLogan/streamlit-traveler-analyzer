...
def standardize_dataframe(df, measurement_df=None):
    ...
    # ========================================================================
    # STEP 12: Derive missing columns from available data (for bypass mode)
    # ========================================================================
    result_df = derive_missing_columns(result_df)
    
    # ========================================================================
    # STEP 13: Ensure all required columns exist with defaults
    # ========================================================================
    required_columns = {
        'Open': '',
        'Output1': None,
    ...
    # ========================================================================
    # STEP 14: Select and order columns
    # ========================================================================
    final_columns = [
...
def export_all_models_to_excel(all_results, report_time, measurement_df=None):
    ...
    light_blue_fill = PatternFill(start_color='E3F2FD', end_color='E3F2FD', fill_type='solid')  # Light blue for Prox < 1.0
    yellow_highlight = PatternFill(start_color='FFEB3B', end_color='FFEB3B', fill_type='solid')  # Bright yellow for Prox < 0.025
    ...
    for sheet_name in workbook.sheetnames:
        ...
        for col_idx, cell in enumerate(worksheet[header_row], start=1):
            ...
            elif cell.value == 'Prox':
                prox_col = col_idx
        
        # Apply highlighting to Arrival_Brackets and Prox columns
