"""
Excel Exporter v23 enhanced (v4) - Unified Export for Both Bypass and Normal Modes
...
def export_all_models_to_excel(all_results, report_time, measurement_df=None, 
    ...
    for sheet_name in workbook.sheetnames:
        ...
        # Set column widths (3.3677 = 40 pixels). Actual results: 2.56, 30 pixels. 4.44 gets the desired result.
