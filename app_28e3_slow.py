...
from custom_range_calculator_slow import apply_custom_ranges_advanced, apply_full_range_advanced
...
st.header("🧬 Data Processor + Model A/B/C/G Detector with fast mode. v28e3 slow")
