...
from custom_range_calculator_0810b import apply_custom_ranges_advanced, apply_full_range_advanced
...
st.header("🧬 Data Processor + Model A/B/C/G Detector with fast mode. v28e2_0810b")
            ...
            try:
                ...
                if 'M #' in final_df_filtered.columns:
                    ...
                    if grp_1a_df.empty:
                        ...
                        g_results = _g(grp_1a_df, report_time, key_suffix="_bypass")
