...
# *** Change the terminologies and structure to fit model_B example file
# Logical expansion for polarity transitions, M # symmetry, and strength traveler sequencing
