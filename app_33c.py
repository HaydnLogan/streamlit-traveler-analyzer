...
# Streamlit app
st.title("🌌 Traveler Report Generator v33c")
...
st.markdown("---")
st.caption("🌌 Traveler Report Generator v33c | Full Range (single), Full Range (multiple), Custom Ranges, HOD/LOD Mode with Origin Filtering")
