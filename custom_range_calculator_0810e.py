"""
this is version e of 0810.  0810 is fast, prints 16,000 lines in under 10 seconds, but has incorrect data! :-(
Macedonia[-1], Macedonia[-2], Wasp-12b[-1], Wasp-12b[-2] are all missing and Macedonia[0] prints the wrong date.
This version e should fix those errors.  Help from free gpt.
"""
