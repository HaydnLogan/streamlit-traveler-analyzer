...
from custom_range_calculator_1125_15 import (
...
st.set_page_config(
    page_title="Swing Analysis Tool 05e_15",
    page_icon="",
    layout="wide"
)
...
def main():
    st.title(" Market Swing Analysis Tool 05e_15 Two Pass")
            ...
            try:
                ...
                if st.button(" Generate Cluster Tables", key="gen_cluster_tables", type="primary"):
                    with st.spinner("Generating cluster tables with two-pass processing..."):
                        ...
                        st.success(f"[OK] All cluster tables generated in {total_time:.2f}s!")
