...
def main():
    st.title(" Market Swing Analysis Tool 05e_22a5 Two Pass")
                        ...
                        with st.spinner("Processing all 23 trading models using uploaded traveler report..."):
                            ...
                            try:
                                ...
                                if 'Feed' in small_hlc_df.columns:
                                    ...
                                    # Process both feeds together through two-pass logic
                                    st.write("  Processing both feeds with Pass 1 & Pass 2...")
