...
def create_multi_day_excel(all_day_reports, asset_id, trading_day_base):
    ...
    with pd.ExcelWriter(output, engine='xlsxwriter') as writer:
        ...
        for tab_name, df in all_day_reports:
            ...
            # Apply highlighting
            try:
                apply_excel_highlighting(workbook, worksheet, df, is_custom_ranges=False)
...
# Streamlit app
st.title("🌌 Traveler Report Generator v33e")
...
st.markdown("---")
st.caption("🌌 Traveler Report Generator v33e | Full Range (single), Full Range (multiple), Custom Ranges, HOD/LOD Mode with Origin Filtering")
