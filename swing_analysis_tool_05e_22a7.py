...
def main():
    st.title(" Market Swing Analysis Tool 05e_22a7 Two Pass")
                    ...
                    if not bypass_mode_active:
                        ...
                        with st.spinner("Processing all 23 trading models using uploaded traveler report..."):
                            ...
                            try:
                                ...
                                # Process models with proper structure
                                all_results = process_all_models(
                                    measurement_df=bypass_measurement_df,  # Created from M#s in traveler report
