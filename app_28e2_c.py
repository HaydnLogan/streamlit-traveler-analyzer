...
from custom_range_calculator_0810e import apply_custom_ranges_advanced, apply_full_range_advanced
...
st.header("🧬 Data Processor + Model A/B/C/G Detector with fast mode. v28e2_0810c")
