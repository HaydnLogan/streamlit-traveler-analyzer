...
def process_cluster_tables_two_pass(
    ...
    try:
        ...
        for hlc_df, feed_name in hlc_df_list:
            ...
            window_low = feed_start - window_radius
            window_high = feed_start + window_radius
            
            # Display info
            st.info(f"🧮 {feed_name} Feed Window: [{window_low:.2f}, {window_high:.2f}] around Open = {feed_start:.2f}")
