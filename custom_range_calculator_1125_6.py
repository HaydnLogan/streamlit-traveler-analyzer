                ...
                if hlc_data_sorted and not measurement_df_pass1.empty:
                    ...
                    if len(unique_dates) > 0:
                        ...
                        for hlc_item in pass1_data:
                            ...
                            # CRITICAL: Calculate raw M values first
                            calc = calculate_raw_m_values(hlc_item, range_low, range_high)
                            if not calc:
                                continue
                            ...
                            valid_results = find_valid_m_values(
                                ...
                                raw_m_low=calc['raw_m_low'],  # Use calculated raw M low
                                raw_m_high=calc['raw_m_high'],  # Use calculated raw M high
