"""
Swing Analysis Tool 05a - Integrated Version
=============================================
Features:
...
st.set_page_config(
    page_title="Swing Analysis Tool 05a_1",
    page_icon="📊",
    layout="wide"
)
...
def analyze_daily_data(df, day_start_hour=18, swing_threshold=30, drawdown_limit=25, exit_at_16=True):
...
def analyze_ny_session(df, day_start_hour=18, swing_threshold=30, drawdown_limit=25):
    """
...
def main():
    ...
    with col1:
        file_3m = st.file_uploader("3m", type=['csv', 'xlsx', 'xls'], key="file_3m")
    
    with col2:
        file_5m = st.file_uploader("5m", type=['csv', 'xlsx', 'xls'], key="file_5m")
    
    with col3:
        file_6m = st.file_uploader("6m", type=['csv', 'xlsx', 'xls'], key="file_6m")
    
    with col4:
        file_15m = st.file_uploader("15m", type=['csv', 'xlsx', 'xls'], key="file_15m")
