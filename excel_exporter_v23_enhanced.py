"""
Excel Exporter v23 enhanced (v3) - Unified Export for Both Bypass and Normal Modes
...
def export_all_models_to_excel(all_results, report_time, measurement_df=None, 
    ...
    yellow_highlight = PatternFill(start_color='FFEB3B', end_color='FFEB3B', fill_type='solid')  # Bright yellow for Prox < 0.25
